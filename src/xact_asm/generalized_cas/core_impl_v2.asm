...
%macro gencas_core_impl_v2_prelude 0
...
%macro gencas_core_impl_v2_body 0
    .x_begin:
    ...
    .check_precondition_locks_step_1:
        ...
        jnz .on_resource_locked

    .check_precondition_locks_step_2:
        add r8, PRECONDITION_SIZE
        sub rcx, 1
        cmp rcx, 0
        jnz .check_precondition_locks_step_1
    ...
    .check_operation_locks_step_2:
        ...
        sub rcx, 1
        cmp rcx, 0
        jnz .check_operation_locks_step_1
    ...
    .precondition_loop_step:
        ...
        .precondition_eq_check:
            ...
            jne .on_precondition_failed
            jmp .precondition_check_success

        .precondition_neq_check:
            mov r9, precond_target(r8)
            mov rax, [r9]
            cmp rax, precond_arg1(r8)
            jz .on_precondition_failed
            jmp .precondition_check_success
