...
function(add_shared_cxx_flags)
    foreach(flag ${ARGN})
        ...
        set(CM_SHARED_CXX_FLAGS "${CM_SHARED_CXX_FLAGS} ${flag}")
    endforeach()
...
function(add_shared_c_flags)
    foreach(flag ${ARGN})
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${flag}")
        set(CM_SHARED_C_FLAGS "${CM_SHARED_C_FLAGS} ${flag}")
    endforeach()
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS}" PARENT_SCOPE)
...
function(set_default_compiler_flags)
    ...
    elseif("${CMAKE_BUILD_TYPE}" STREQUAL "DEBUG")
        add_shared_cxx_flags(-g)
        add_shared_cxx_flags(-O0)
        add_shared_c_flags(-O0)
        add_shared_c_flags(-g)
